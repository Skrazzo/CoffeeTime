import s from '../scss/FourthSection.module.scss';
...
export default function FourthSection({ sm, xl, xl2 }) {
    return (
        
        <div className={`p-4 lg:p-44 grid grid-cols-2 ${s.container}`}>
            <div className='flex items-center justify-start'>
                <p className={`${s.font}`}>White Coffees</p>
            </div>
            ...
            <div className='col-span-2 sm:col-span-1 flex justify-center sm:justify-start pt-12'>
                <div>
